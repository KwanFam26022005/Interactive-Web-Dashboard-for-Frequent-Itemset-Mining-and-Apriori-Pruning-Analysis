...
10. **[10] The Apache Software Foundation (2025).** *Apache ECharts: An Open Source JavaScript Visualization Library (Version 5.6.0).* Authoritative: [https://echarts.apache.org/](https://echarts.apache.org/). Package: `npm:echarts@5.6.0`.
